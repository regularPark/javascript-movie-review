...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _Rate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Rate */ \"./src/components/Rate.ts\");\n\nclass DetailModal {\n    constructor(movie, rate) {\n        this.movie = movie;\n        this.rate = rate;\n        this.template = ({ id, title, poster_path: posterPath, overview, vote_average: voteAverage, genres, }) => `\n          <div class=\"modal-container\" id=\"${id}\">\n              <div class=\"title-wrapper\">\n                  <p class=\"modal-title\">${title} \n                  </p>\n                  <button class=\"close-button\">\n                      <img src=\"assets/close.png\" />\n                  </button>\n              </div>\n              <div class=\"modal-card\">\n                  <img\n                    class=\"modal-thumbnail skeleton\"\n                    src=\"https://image.tmdb.org/t/p/w220_and_h330_face${posterPath}\"\n                    loading=\"lazy\"\n                    alt=\"${title}\"\n                  />\n                  <div class=\"modal-info\">\n                      <div class=\"modal-genre-score\">\n                          <p class=\"modal-genres\">${genres\n            .map((genre) => genre.name)\n            .join(', ')}</p>\n                          <p class=\"modal-score\"><img src=\"assets/star_filled.png\" alt=\"별점\" /> ${voteAverage}</p>\n                          <p class=\"modal-overview\">${overview}</p>\n                      </div>\n                      <div class=\"user-score\"></div>\n                  </div>\n              </div>\n          </div>\n      `;\n        this.closeModal = () => {\n            this.modal.replaceChildren();\n            this.modal.close();\n        };\n        this.modal = document.querySelector('.modal');\n        this.modal.replaceChildren();\n        this.init();\n    }\n    init() {\n        this.render();\n        this.addEvent();\n    }\n    render() {\n        var _a;\n        this.modal.insertAdjacentHTML('beforeend', this.template(this.movie));\n        (_a = document.querySelector('.user-score')) === null || _a === void 0 ? void 0 : _a.insertAdjacentHTML('beforeend', _Rate__WEBPACK_IMPORTED_MODULE_0__[\"default\"].template());\n        if (this.rate)\n            _Rate__WEBPACK_IMPORTED_MODULE_0__[\"default\"].renderStar(this.rate);\n    }\n    addEvent() {\n        var _a;\n        (_a = document.querySelector('.close-button')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', this.closeModal);\n        _Rate__WEBPACK_IMPORTED_MODULE_0__[\"default\"].listener(this.movie.id);\n    }\n}\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DetailModal);\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/components/DetailModal.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _MovieFetcher__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MovieFetcher */ \"./src/domain/MovieFetcher.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\nclass MovieAPI {\n    getPopularMovies(page = 1) {\n        return __awaiter(this, void 0, void 0, function* () {\n            return _MovieFetcher__WEBPACK_IMPORTED_MODULE_0__.MovieFetcher.fetch('/movie/popular', `?language=ko-KR&page=${page}&api_key=${\"5a5a93b7a6947899b5d1ae8c47891133\"}`);\n        });\n    }\n    getSearchMovies(query, page = 1) {\n        return __awaiter(this, void 0, void 0, function* () {\n            return _MovieFetcher__WEBPACK_IMPORTED_MODULE_0__.MovieFetcher.fetch('/search/movie', `?language=ko-KR&query=${query}&page=${page}&include_adult=false&api_key=${\"5a5a93b7a6947899b5d1ae8c47891133\"}`);\n        });\n    }\n    getGenreList() {\n        return __awaiter(this, void 0, void 0, function* () {\n            return _MovieFetcher__WEBPACK_IMPORTED_MODULE_0__.MovieFetcher.fetch('/genre/movie/list', `?api_key=${\"5a5a93b7a6947899b5d1ae8c47891133\"}&language=ko-KR`);\n        });\n    }\n    getDetail(id) {\n        return __awaiter(this, void 0, void 0, function* () {\n            return _MovieFetcher__WEBPACK_IMPORTED_MODULE_0__.MovieFetcher.fetch('/movie/', `${id}?api_key=${\"5a5a93b7a6947899b5d1ae8c47891133\"}&language=ko-KR`);\n        });\n    }\n}\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new MovieAPI());\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/domain/MovieAPI.ts?");

/***/ }),

/***/ "./src/domain/MovieFetcher.ts":
/*!************************************!*\
  !*** ./src/domain/MovieFetcher.ts ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"MovieFetcher\": () => (/* binding */ MovieFetcher)\n/* harmony export */ });\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nconst BASE_URL = 'https://api.themoviedb.org/3';\nconst MovieFetcher = {\n    fetch(path, url) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const res = yield fetch(`${BASE_URL}${path}${url}`);\n            if (!res.ok)\n                throw yield res.json();\n            const response = yield res.json();\n            return response;\n        });\n    },\n};\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/domain/MovieFetcher.ts?");
